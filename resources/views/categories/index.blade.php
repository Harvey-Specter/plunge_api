          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Name</th> <th>Code</th> <th>Remark</th> <th>Owner</th> <th>Stock_count</th> <th>Create_time</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$category->name}}</td> <td>{{$category->code}}</td> <td>{{$category->remark}}</td> <td>{{$category->owner}}</td> <td>{{$category->stock_count}}</td> <td>{{$category->create_time}}</td>
